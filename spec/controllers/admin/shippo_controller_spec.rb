...
describe Spree::Admin::ShippoController do
  ...
  describe "#view_order" do
    ...
    it "redirects to order url" do
      expect(subject).to redirect_to('https://goshippo.com/spreecommerce/orders/123?email=test%40test.com&store_name=Spree+Demo+Site&store_url=demo.spreecommerce.com')
    end
  end
  ...
  describe "#view_orders" do
    ...
    it "redirects to orders url" do
      expect(subject).to redirect_to('https://goshippo.com/spreecommerce/orders?email=test%40test.com&store_name=Spree+Demo+Site&store_url=demo.spreecommerce.com')
    end
  end
end